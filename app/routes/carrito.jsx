...
export default function Carrito() {
  ...
  //Precio total de todos los articulos
  useEffect(() => {
    ...
    <main className="contenedor">
      ...
      <div className="contenido">
        ...
        <div className='carrito'>
          ...
          <h2>Articulos</h2>
          {carrito?.length === 0 ? 'Es momento de comprar lo que necesites' : (
            carrito?.map(producto => (
              <div key={producto.id} className='producto'>
                ...
                <div>
                  ...
                  <p className='precio'>Precio Unitario: <span>${producto.precio}</span></p>
